                ...
                }
                {
                    ...
                    lv_obj_set_style_flex_track_place(obj, LV_FLEX_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, 90, 90);
                            lv_obj_add_event_cb(obj, action_toggle_roation_settings, LV_EVENT_CLICKED, (void *)0);
...
void create_screen_brightness_screen() {
    ...
    lv_obj_set_style_text_font(obj, &ui_font_mono40, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_back_button(obj, 50);
...
void tick_screen_brightness_screen() {
    tick_user_widget_back_button(50);
}
...
void create_screen_volume_screen() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(theme_colors[active_theme_index][0]), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_back_button(obj, 57);
            lv_obj_add_event_cb(obj, action_nav_to_home_scr, LV_EVENT_CLICKED, (void *)0);
        }
    }
...
void tick_screen_volume_screen() {
    tick_user_widget_back_button(57);
}
...
void create_screen_wifi_screen() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(theme_colors[active_theme_index][0]), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_back_button(obj, 60);
            lv_obj_add_event_cb(obj, action_nav_to_home_scr, LV_EVENT_CLICKED, (void *)0);
        }
        {
            // mainContainerWifi
                ...
                }
                {
                    ...
                    lv_obj_set_style_flex_track_place(obj, LV_FLEX_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        ...
                        }
                        {
                            ...
                            lv_label_set_text_static(obj, "http://localhost:8080/api");
                        }
                    }
                }
                {
...
void tick_screen_wifi_screen() {
    tick_user_widget_back_button(60);
}
...
void create_screen_clock_screen() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(theme_colors[active_theme_index][0]), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            // clockGaugeImage
            lv_obj_t *obj = lv_img_create(parent_obj);
            objects.clock_gauge_image = obj;
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_clock_gauge);
        }
        {
            // timeLabel
            lv_obj_t *obj = lv_label_create(parent_obj);
...
void create_screen_digital_clock_screen() {
    lv_obj_t *obj = lv_obj_create(0);
    objects.digital_clock_screen = obj;
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 466, 466);
    ...
    lv_obj_set_style_bg_img_tiled(obj, true, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            // digitalDateLabel_1
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.digital_date_label_1 = obj;
            lv_obj_set_pos(obj, 0, 90);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_obj_set_style_text_font(obj, &ui_font_mono30, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    tick_screen_digital_clock_screen();
}
...
void create_screen_crypto_screen() {
    ...
    lv_obj_set_style_bg_img_tiled(obj, true, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text_static(obj, "BITCOIN USD");
        }
        {
            ...
            lv_obj_set_style_text_font(obj, &ui_font_mono_bold20, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text_static(obj, "1 day");
        }
    }
...
void create_screen_stock_screen() {
    ...
    lv_obj_set_style_bg_img_tiled(obj, true, LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_text_font(obj, &ui_font_mono_light30, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text_static(obj, "AAPL USD");
        }
        {
            // stockTimeFrameLabel
            lv_obj_t *obj = lv_label_create(parent_obj);
        ...
        }
        {
            ...
            lv_obj_set_style_text_font(obj, &ui_font_mono30, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_label_set_text_static(obj, "Apple Inc.");
        }
        {
            // stockMarketOpenCont
            lv_obj_t *obj = lv_obj_create(parent_obj);
...
void change_color_theme(uint32_t theme_index) {
    ...
    }
    {
        ...
        lv_obj_set_style_bg_color(objects.screens_refetch_button, lv_color_hex(theme_colors[theme_index][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    }
    {
        ...
        lv_obj_set_style_text_color(objects.crypto_icon, lv_color_hex(theme_colors[theme_index][11]), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    }
    {
        ...
        lv_obj_set_style_text_color(objects.stock_icon, lv_color_hex(theme_colors[theme_index][11]), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_invalidate(objects.digital_clock_screen);
    lv_obj_invalidate(objects.crypto_screen);
    lv_obj_invalidate(objects.stock_screen);
}
uint32_t theme_colors[1][12] = {
    { 0xff000000, 0xff323232, 0xff9c0808, 0xff4a484a, 0xff83a510, 0xffe6d239, 0xff38384c, 0xff2cb60c, 0xff9c9c9c, 0xff4f0b0b, 0xffdf0a0a, 0xffcdcdcd },
};
...
// Set default LVGL theme
    ...
    create_screen_digital_clock_screen();
